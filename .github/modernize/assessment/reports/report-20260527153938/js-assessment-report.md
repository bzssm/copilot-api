Checking /tmp/workspace/bzssm/copilot-api/package.json
...
Run ncu --format group --packageFile /tmp/workspace/bzssm/copilot-api/package.json -u to upgrade /tmp/workspace/bzssm/copilot-api/package.json
