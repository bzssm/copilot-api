...
import { setupAuth } from "./lib/token"
...
export const start = defineCommand({
  ...
  args: {
    ...
    hmac: {
      type: "string",
      description:
        "Provide an HMAC credential in the format {integration-id}:{hmac-key}. Saved to disk and used for request signing instead of a GitHub token",
    },
    "claude-code": {
      alias: "c",
      type: "boolean",
